...
s0_color = #459af4ff
s0_scale_image = true
s0_images = /usr/share/images/desktop-base/joy-grub.png;
s0_adjust_image = false
s0_skydome = true
s0_skydome_image = /usr/share/images/desktop-base/spacefun-wallpaper-widescreen.svg
...
[core]
as_active_plugins = core;resize;png;place;firepaint;imgjpeg;svg;decoration;regex;splash;resizeinfo;animation;grid;gnomecompat;wobbly;text;ring;animationaddon;fade;cube;3d;expo;scale;move;switcher;scalefilter;showdesktop;rotate;scaleaddon;addhelper;
